...
def main():
    ...
    setup(
        name="ctodd-python-lib-sentry",
        version=version,
        python_requires=">3.0,<3.7",
        description=("Python utilities used for interacting with Sentry Bug Reporting"),
        url="https://github.com/ChristopherHaydenTodd/ctodd-python-lib-sentry",
        author="Christopher H. Todd",
        author_email="Christopher.Hayden.Todd@gmail.com",
        classifiers=["Programming Language :: Python"],
        keywords=["python", "libraries", "Sentry"],
        packages=packages,
